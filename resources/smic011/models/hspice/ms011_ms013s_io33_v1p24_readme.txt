...
1. Update History:
      ...
      v2.1: Main document change description:
       ...
       v2.2: Main document files change description:
            ...
            Attachment files change description:
             ...
             Above changes have done modification in following attached file:"ms011_ms013s_io33_interconnect_struct_1.txt","ms011_ms013s_io33_interconnect_struct_2.txt","ms011_ms013s_io33_v2p3_res.ckt","ms011_ms013s_io33_v2p3_mim.mdl","ms011_ms013s_io33_v2p3.mdl", "ms011_ms013s_io33_v2p3.lib", "ms011_ms013s_io33_v2p3_dio.mdl","ms011_ms013s_io33_fit_C.pdf""ms011_ms013s_io33_fit_D.pdf", "ms011_ms013s_io33_fit_E.pdf" and "ms011_ms013s_io33_fit_F.pdf"
	...
	v2.3:Main document files change description:
	     ...
	     Attachment files change description:
	       1. Revise and re-extract all MOS models from new 0.13um process fitting models including svt/hvt/lvt/io33/nt12/nt33 devices
               2. Update noise models based on silicon data of 0.13um model wafers and only minute change of corner parameters
               3. Keep stress related parameters of n12/p12/n33/p33, revisng "sa0"/"sb0" to "saref"/"sbref" to match Bsim4 armaments definition
               4. Change one parameter "sigma" for all monte-calo models to separate corresponding model parameters as "sigma_mos", "sigma_res", "sigma_mom", "sigma_mim" in .lib file for solving naming conflict issue during simulation
               5. Add scale multiple factor 0.9 in resistor macro model by replacing "lr" to "lr*0.9" for parameters ("rvc1", "rvc2") in "ms011_ms013s_io33_v2p3_res.ckt" file
               6. Add width shift of "-0.003*0.9um=-2.7e-9m" by mask sizing LOTA rules in all poly related resistor macro model by revising parameter "dw" in "ms011_ms013s_io33_v2p3_res.ckt" file
               7. Add six small size NPN BJT devices in (NPN12A100, NPN12A25, NPN12A4, NPN33A100, NPN33A25 and NPN33A4), two two-mask MIM devices of 1fF/um2 and 1.5fF/um2 (MIM1_TM, MIM15_TM), and no changes for other devices including diode/varactor/MOM and BEOL interconnect models
               8. Keep model card format and device names as previous 2.2 version including scale factor syntax in models
               9. Remove ELDO format model card files since ELDO model format is no longer the default support model format in SMIC, and changed model version from 2.2 to 2.3
               10. Add six npn bjt samples in GDSII files, and modified metal interconnect of two bjt gds files (NPN12A400.gds, NPN12A225.gds) for avoiding violation of design rules. Zipped all ASCII and GDSII files separately in Attachment files "ASCII.7z" and "GDSII.7z"
...
2. Files:
      ...
      ms011_ms013s_io33_v1p24_readme.txt                   .... This file!
      ms011_ms013s_io33_v1p24.lib                          .... Corner values for MOSFETs, diode, BJT, resistors, MIM, MOM and varactor
      ms011_ms013s_io33_v1p24.mdl                          .... Model parameters file for MOSFETs
      ms011_ms013s_io33_v1p24_mis.mdl                      .... Model parameters file for MOSFETs
      ms011_ms013s_io33_v1p24_dio.mdl                      .... Model parameters file for diode
      ms011_ms013s_io33_v1p24_bjt.mdl                      .... Model parameters file for BJT
      ms011_ms013s_io33_v1p24_mim.mdl                      .... Model parameters file for MIM
      ms011_ms013s_io33_v1p24_res.mdl                      .... Model parameters file for resistors
      ms011_ms013s_io33_v1p24_res.ckt                      .... Resistor, MOM capacitance, MIM capacitance and varactor macro model 
...
3. How to use SMIC SPICE models in HSPICE:
      ...
      a. Specify MOS, diode and BJT model corner by the '.lib' statement;

         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' TT
                                                       ^^ mos model corner
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' DIO_TT
                                                       ^^ diode model corner
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' BJT_TT
                                                       ^^ BJT model corner   
         
      b. Include MOS, diode, BJT, resistor and mim model parameters by the '.include' statement;
         
         .include '/xxx/xxx/ms011_ms013s_io33_v1p24.mdl'

         .include '/xxx/xxx/ms011_ms013s_io33_v1p24_dio.mdl'

         .include '/xxx/xxx/ms011_ms013s_io33_v1p24_bjt.mdl'        

         .include '/xxx/xxx/ms011_ms013s_io33_v1p24_res.mdl'
         
         .include '/xxx/xxx/ms011_ms013s_io33_v1p24_mim.mdl'
 
      c. Call resistor, MIM , MOM, Varactor macro model subcircuit by the following statement;

         .include '/xxx/xxx/ms011_ms013s_io33_v1p24_res.ckt'
         
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' DIO_TT
                                                       ^^ diode model corner

         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' RES_TT
                                                       ^^ resistor model corner

         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' MIM_TT
                                                       ^^ mim model corner

         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' MOM_TT
                                                       ^^ mom model corner

         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' VAR_TT
	 ...
	 subcircuit condition you want to simulate. 
      ...
      f. Specify mos, resistor, mom, mim, varactor and BJT model corner by the '.lib' statement;
         ...
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' MOS_MC
                                                       ^^ mos monte carlo model
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' RES_MC
                                                       ^^ resistor monte carlo model
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' MOM_MC
                                                       ^^ mom monte carlo model
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' MIM_MC
                                                       ^^ mim monte carlo model
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' VAR_MC
                                                       ^^ varactor monte carlo model
         .lib '/xxx/xxx/ms011_ms013s_io33_v1p24.lib' BJT_MC
...
6. Monte Carlo Statistical model
   ...
   The model is given in HSPICE format. Running Monte Carlo by using this model, user can get the distribution of the simulation target.
...
.lib 'ms011_ms013s_io33_v1p24.lib' mos_mc
.temp 25
* assume source at 0
vg1 g1 0 1.2
vd1 d1 0 1.2
vd2 d2 0 1.2
vb b 0 0
m1 d1 g1 0 b n12 w=10u l=0.13u
.dc  sweep  monte=500
.print dc  id1=i(vd1)
.end
---------------------------------------------------------------
...
.lib 'ms011_ms013s_io33_v1p24.lib' tt
.temp 25  
 xm1 d1 g1 0 0 n12_mis_ckt w=10u l=0.13u mr=1 mismod=1 
 xm2 d2 g1 0 0 n12_mis_ckt w=10u l=0.13u mr=1 mismod=1
 vd1 d1 0 1.2
 vg1 g1 0 1.2
 vd2 d2 0 1.2
 .dc monte=500
...
****************************************************************************
$ this is a test
.lib 'ms013_io33_v1p24.lib' mim_tt
.inc 'ms013_io33_v1p24_res.ckt'
.option captab 
.temp 25
x161 161 0 mim1_ckt w=5u l=5u mr=1 mismod_mim=1
x162 162 0 mim1_ckt w=5u l=5u mr=1 mismod_mim=1
v1 1 0 0
r161 1 161 1e-3
r162 1 162 1e-3
.dc monte=500
