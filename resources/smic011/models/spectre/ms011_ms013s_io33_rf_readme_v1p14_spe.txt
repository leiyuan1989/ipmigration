...
1.Files:
      ...
      ms011_ms013s_io33_rf_readme_v1p14_spe.txt     	.... This file!
      ms011_ms013s_io33_rf_v1p14_spe.lib            	.... Corner values for RF mos, Resistors, MIM, MOM, Varactors and Inductors
      ms011_ms013s_io33_rf_mos_v1p14_spe.ckt        	.... Subcircuit model of RF MOS
      ms011_ms013s_io33_rf_spir_ind_v1p14_spe.ckt       	.... Subcircuit model of spiral inductor
      ms011_ms013s_io33_rf_diff_ind_v1p14_spe.ckt       	.... Subcircuit model of differential inductor
      ms011_ms013s_io33_rf_3T_diff_ind_v1p14_spe.ckt    	.... Subcircuit model of 3-terminal differential inductor formed from TM2 or ALPA
      ms011_ms013s_io33_rf_3Tdiff_1talpa_spe_v1p14.ckt         .... Subcircuit model of 3-terminal differential inductor 
      ms011_ms013s_io33_rf_3Tdiff_1talpa_psub_v1p14.ckt        .... Subcircuit model of 3-terminal differential inductor with psub
      ms011_ms013s_io33_ind_rf_pgs_psub_n_v1p14_spe.ckt        	.... Subcircuit model of width scalable spiral inductor with pgs and psub
      ms011_ms013s_io33_ind_rf_pgs_n_v1p14_spe.ckt        	.... Subcircuit model of width scalable spiral inductor with pgs 
      ms011_ms013s_io33_diff_ind_3t_rf_pgs_psub_n_v1p14_spe.ckt .... Subcircuit model of width scalable 3-terminal differential inductor with pgs and psub
      ms011_ms013s_io33_diff_ind_3t_rf_pgs_n_v1p14_spe.ckt     	.... Subcircuit model of width scalable 3-terminal differential inductor with pgs 
      ms011_ms013s_io33_diff_ind_rf_pgs_psub_n_v1p14_spe.ckt    .... Subcircuit model of width scalable differential inductor with pgs and psub
      ms011_ms013s_io33_diff_ind_rf_pgs_n_v1p14_spe.ckt        	.... Subcircuit model of width scalable differential inductor with pgs 
      ms011_ms013s_io33_rf_mim_v1p14_spe.ckt        	.... Subcircuit model of MIM 
      ms011_ms013s_io33_rf_mom_v1p14_spe.ckt        	.... Subcircuit model of MOM 
      ms011_ms013s_io33_rf_var_v1p14_spe.ckt        	.... Subcircuit model of varactor
      ms011_ms013s_io33_rf_res_v1p14_spe.ckt        	.... Subcircuit model of sab resistor
      ms011_ms013s_io33_rf_TM2_res_v1p14_spe.ckt 	.... model card for TM2 resistor and ALPA resistor
      res_rf.va                                 	.... Resistor module
      gc_rf.va                                  	.... Gate current model for MOS varactor
      ...
      ind_rf_n2d5r60.gds						.... GDSII file for spiral inductor with half turns
...
2. How to use SMIC SPICE models in SPECTRE :
   ...
   ** Load model cards and select corner
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=mos_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=mim_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=mom_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=res_tt 
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=tm2_res_tt 
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=var_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=spirind_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diffind_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=3tdiffind_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=ind_rf_pgs_psub_n_tt 
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=ind_rf_pgs_n_tt 
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_3t_rf_pgs_psub_n_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_3t_rf_pgs_n_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_rf_pgs_psub_n_tt
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_rf_pgs_n_tt

    ** Load monte carlo models
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=mos_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=mim_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=mom_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=res_mc 
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=tm2_res_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=var_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=spirind_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diffind_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=3tdiffind_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=ind_rf_pgs_psub_n_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=ind_rf_pgs_n_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_3t_rf_pgs_psub_n_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_3t_rf_pgs_n_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_rf_pgs_psub_n_mc
   include "ms011_ms013s_io33_rf_v1p14_spe.lib" section=diff_ind_rf_pgs_n_mc
   ...
   ** Call the models
    ...
    X8 (1 2 T1) diff_ind_3t_rf r=60u n=3
    X9 (1 2 T1) diff_ind_3t_alpa_rf r=60u n=3.5
    ...
    or Spectre 7.01ISR20 , or Spectre 7.1ISR6 , or Spectre version after 7.1ISR6 to run 3-terminal differential inductor. 
    And please do not use Spectre version 6.2.1 32bit 05/29/2008 05:19 (sfrh56) until the version before 7.01ISR20 to run simulation, 
    because the mutual coupling coefficient K will be restricted to [-1,1] within these versions.
...
3. The Capability of Model
        ...
        *----------------------------------------------------------------------------------------------*
        ...
        For the detail RF MOS model capacity please refer to the section 7.3.1 and section 7.3.6 of main document 
	...
	*-----------------------------------------------------------------------------------------------------------------*
	...
	temperature range:-40C~125C
        ...
        *------------------------------------------------------------------------------------------------------------------------------------------* 
        ...
        For the detail 3-Terminal Differential model capacity please refer to the section 7.6.1 and 7.7.1 of main document
...
4.Corner Model: 
      ...
      ----------------------------------------------------
      Note: Use 5*sigma of Cgg mapping data standard deviation for MOS Varactor corner, where mapping data got from BP1475#20,#21.
	    Update gate leakage current using empirical model to solve discontinuous problem of its derivatives.
...
5.Statistical Model: 
      ...
      ----------------------------------------------------
                               mom_mc : Monte Carlo    
      ----------------------------------------------------
      MOS Varactor             name : statistical model
      ----------------------------------------------------
                               var_mc : Monte Carlo    
      ----------------------------------------------------
      Spiral Inductor          name : statistical model
