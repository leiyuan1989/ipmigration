...
parser.add_argument('--gui',       default=False,                type=bool, help='Use gui as input or not') #
parser.add_argument('--input',     default='./cell_setting.csv', type=str,  help='cell setting file') #
